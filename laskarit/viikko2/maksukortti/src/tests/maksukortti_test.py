...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_pystyy_ostamaan_edullisen_lounaan_kun_rahaa_kortilla_on_edullisen_lounaan_verran(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_rahaa_kortilla_on_maukkaan_lounaan_verran(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
